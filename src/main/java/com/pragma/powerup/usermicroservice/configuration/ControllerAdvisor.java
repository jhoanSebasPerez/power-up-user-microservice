...
public class ControllerAdvisor {
    ...
    @ExceptionHandler(UserHasNotLegalAgeException.class)
    public ResponseEntity<Map<String, String>> handleUserHasNotLegalAge(
            UserHasNotLegalAgeException userHasNotLegalAgeException) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, USER_HAS_NOT_LEGAL_AGE));
    }
}
